...
def get_spec_code_prompts():
    script_dir_path = os.path.dirname(os.getcwd())
    spec_prompt_path = os.path.join(script_dir_path, 'Scripts/prompts/COT_SPEC_TEMPLATE.file')
    code_prompt_path = os.path.join(script_dir_path, 'Scripts/prompts/COT_CODE_TEMPLATE.file')
    if not (os.path.exists(spec_prompt_path) or os.path.exists(code_prompt_path)):
        print("Scripts/prompts/COT_SPEC_TEMPLATE.file or  Scripts/prompts/COT_CODE_TEMPLATE.file not found!!")
        return
